    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (!newVariant) {
          ...
          var newPrice = newVariant['price'].replace('.','');
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productMetaPrices.innerHTML += '<span class="ProductMeta__Price Price Text--subdued u-h4" data-money-convertible>' + __WEBPACK_IMPORTED_MODULE_4__helper_Currency__["default"].formatMoney(newPrice, window.theme.moneyFormat) + '</span>';
          }
